...
#undef ROWCOL
  ...
  inline zVEC2 Alg_Min( zVEC2 const &, zVEC2 const & )               zCall( 0x00516F00 );
  inline zVEC3 Alg_Min( zVEC3 const &, zVEC3 const & )               zCall( 0x005171D0 );
  inline zVEC4 Alg_Min( zVEC4 const &, zVEC4 const & )               zCall( 0x00517680 );
  inline zVEC2 Alg_Max( zVEC2 const &, zVEC2 const & )               zCall( 0x00516F50 );
  inline zVEC3 Alg_Max( zVEC3 const &, zVEC3 const & )               zCall( 0x00517240 );
  inline zVEC4 Alg_Max( zVEC4 const &, zVEC4 const & )               zCall( 0x00517700 );
  inline zVEC2 Alg_Prod( zVEC2 const &, zVEC2 const & )              zCall( 0x00516FA0 );
  inline zVEC3 Alg_Prod( zVEC3 const &, zVEC3 const & )              zCall( 0x005172B0 );
  inline zVEC4 Alg_Prod( zVEC4 const &, zVEC4 const & )              zCall( 0x00517780 );
  inline void Alg_Swap( zVEC2 &, zVEC2 & )                           zCall( 0x00516EC0 );
  inline void Alg_Swap( zVEC3 &, zVEC3 & )                           zCall( 0x00517180 );
  inline void Alg_Swap( zVEC4 &, zMAT4 & )                           zCall( 0x00517620 );
  inline void Alg_Swap( zMAT3 &, zMAT3 & )                           zCall( 0x005187F0 );
  inline void Alg_Swap( zMAT4 &, zMAT4 & )                           zCall( 0x0051B950 );
  inline zMAT3 Alg_Identity2D()                                      zCall( 0x0051C390 );
  inline zMAT3 Alg_Translation2D( zVEC2 & )                          zCall( 0x0051C430 );
  inline zMAT3 Alg_Rotation2D( zVEC2 &, float )                      zCall( 0x0051C4D0 );
  inline zMAT3 Alg_Scaling2D( zVEC2 & )                              zCall( 0x0051C5A0 );
  inline zMAT4 Alg_Identity3D()                                      zCall( 0x0051C640 );
  inline zMAT4 Alg_Translation3D( zVEC3 const & )                    zCall( 0x0051C7A0 );
  inline zMAT4 Alg_Rotation3D( zVEC3 const &, float )                zCall( 0x0051C900 );
  inline zMAT4 Alg_Rotation3DN( zVEC3 const &, float )               zCall( 0x0051C9B0 );
  inline zMAT4 Alg_Rotation3DRad( zVEC3 const &, float )             zCall( 0x0051CA10 );
  inline zMAT4 Alg_Rotation3DNRad( zVEC3 const &, float )            zCall( 0x0051CAC0 );
  inline zMAT4 Alg_Scaling3D( zVEC3 const & )                        zCall( 0x0051CCD0 );
  inline zMAT4 Alg_Perspective3D( float )                            zCall( 0x0051CE30 );
  inline void Alg_ClipAtZ0( zVEC3 &, zVEC3 & )                       zCall( 0x0051CF90 );
  inline float Alg_SqrtInvApprox( float )                            zCall( 0x0051DFD0 );
  inline float Alg_AngleUnitRad( zVEC3 const &, zVEC3 const & )      zCall( 0x00553DE0 );
  inline void Alg_CalcAziElevUnit( zVEC3 const &, float &, float & ) zCall( 0x0078DA60 );
  inline void Alg_CalcAziElev( zVEC3&, float&, float& )              zCall( 0x004798E0 );
